...
use App\Orchid\Screens\Employee;
use App\Orchid\Screens\TimeoffTrackerScreen;
use App\Orchid\Screens\PayrollScreen;
use App\Orchid\Screens\NotificationScreen;
...
Route::screen('/employee', employee::class)->name('platform.employee');
Route::screen('/timeoff', TimeoffTrackerScreen::class)->name('platform.timeoff');
Route::screen('/payroll', PayrollScreen::class)->name('platform.payroll');
...
$this->router->screen('employee', employee::class)->name('platform.employee');
